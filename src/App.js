  ...
  return (
    <div className="App">
          <section className="bg-white dark:bg-gray-900">
                ...
                <Nav setMenu={(value)=>setMenu(value)}/>
...
<section class="bg-white dark:bg-gray-900">
    <div class="h-[32rem] bg-gray-100 dark:bg-gray-800">
        <div class="container px-6 py-10 mx-auto">
            <h1 class="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl dark:text-white">Equipo de trabajo</h1>
    ...
    <div class="container px-6 py-10 mx-auto -mt-72 sm:-mt-80 md:-mt-96">
        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3">
            <div class="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                <img class="object-cover w-full rounded-xl aspect-square"  src={require('./image/miguel.jpeg')} alt="" />

                <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white">Miguel Angel Moreno</h1>

                <p class="mt-2 text-gray-500 capitalize dark:text-gray-300">Gerente General</p>
            ...
            <div class="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                <img class="object-cover w-full rounded-xl aspect-square" src={require('./image/felipe.png')} alt="" />
            ...
            <div class="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                <img class="object-cover w-full rounded-xl aspect-square" src={require('./image/sebas.jpeg')} alt="" />
